...
/**
 * Parses each aircraft's JSON data from the DCS BIOS project. This builds a tree of all the controls and their inputs
 * and outputs for each supported aircraft.
 */
