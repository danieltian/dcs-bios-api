...
class BufferReader {
  ...
  /**
   * Read an UInt16 little endian from the buffer. Advances the buffer position by 2 bytes.
  ...
  /**
   * Read an UInt32 little endian from the buffer. Advances the buffer position by 4 bytes.
